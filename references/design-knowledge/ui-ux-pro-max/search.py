...
# -*- coding: utf-8 -*-
"""
UI/UX Pro Max Search - BM25 search engine for the vendored core knowledge base.

Self-contained: depends only on the Python stdlib and the CSVs in ./data/.
Adapted from ui-ux-pro-max-skill (MIT, Copyright (c) 2024 Next Level Builder).
See ATTRIBUTION.md.

Usage:
    python search.py "<query>" [--domain <domain>] [--max-results 3] [--json]

Domains: color, chart, product, ux, typography, style
"""
...
# ============ CONFIGURATION ============
# Vendored layout: search.py and data/ live in the same folder.
...
if __name__ == "__main__":
    # Force UTF-8 for stdout/stderr (cp1252 default on Windows)
    if sys.stdout.encoding and sys.stdout.encoding.lower() != 'utf-8':
        sys.stdout = io.TextIOWrapper(sys.stdout.buffer, encoding='utf-8')
    if sys.stderr.encoding and sys.stderr.encoding.lower() != 'utf-8':
        sys.stderr = io.TextIOWrapper(sys.stderr.buffer, encoding='utf-8')

    parser = argparse.ArgumentParser(description="UI Pro Max Search (vendored core)")
